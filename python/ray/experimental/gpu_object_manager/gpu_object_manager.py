...
class GPUObjectManager:
    ...
    def add_gpu_object_ref(
        ...
        print(f"adding metadata for {obj_id}")
        ...
        print(f"managed gpu object metadata: {self.managed_gpu_object_metadata}")
    ...
    def get_gpu_object(self, object_id: str) -> List["torch.Tensor"]:
        ...
        print(f"getting gpu object {object_id}")
        if self.is_managed_object(object_id):
            print(f"fetching gpu object {object_id}")
